...
func NewRouter(
	...
	mux.Handle("DELETE /admin/accounts/{id}", authMiddleware.AdminAuth(http.HandlerFunc(adminHandler.DeleteAccount)))
	...
	mux.Handle("GET /admin/charts/daily", authMiddleware.AdminAuth(http.HandlerFunc(adminHandler.GetDailyCharts)))
	mux.Handle("GET /admin/activity", authMiddleware.AdminAuth(http.HandlerFunc(userHandler.GetActivityLog)))
	...
	mux.Handle("GET /admin/users", authMiddleware.AdminAuth(http.HandlerFunc(userHandler.List)))
	mux.Handle("GET /admin/users/{id}", authMiddleware.AdminAuth(http.HandlerFunc(userHandler.Get)))
	mux.Handle("POST /admin/users", authMiddleware.AdminAuth(http.HandlerFunc(userHandler.Create)))
	mux.Handle("PUT /admin/users/{id}", authMiddleware.AdminAuth(http.HandlerFunc(userHandler.Update)))
	mux.Handle("DELETE /admin/users/{id}", authMiddleware.AdminAuth(http.HandlerFunc(userHandler.Delete)))
	mux.Handle("POST /admin/users/bulk-delete", authMiddleware.AdminAuth(http.HandlerFunc(userHandler.BulkDelete)))
	mux.Handle("POST /admin/users/bulk-update", authMiddleware.AdminAuth(http.HandlerFunc(userHandler.BulkUpdate)))
