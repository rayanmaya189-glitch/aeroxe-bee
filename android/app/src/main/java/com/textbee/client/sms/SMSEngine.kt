...
import com.textbee.client.util.RateLimiter
...
class SMSEngine @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_SENT = "com.textbee.client.SMS_SENT"
        const val ACTION_DELIVERED = "com.textbee.client.SMS_DELIVERED"
    }
