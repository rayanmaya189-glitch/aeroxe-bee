...
- Name: api/messages.spec.ts >> Messages API >> POST /api/v1/send without idempotency_key returns 400
- Location: tests/api/messages.spec.ts:19:7
...
Expected substring: "idempotency_key"
Received string:    "invalid X-API-Version header: must be a positive integer"
```
